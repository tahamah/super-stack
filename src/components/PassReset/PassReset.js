...
const PassReset = () => {
    ...
    return (
        <div className="h-[100vh] px-10 pt-20 md:pt-40">
            <div class="w-full mt-40 max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
                <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">
                    Enter your Email
                </h1>

                <form onSubmit={handSend} class="mt-6">
                    <div>
                        <label
                            for="username"
                    ...
                    <div class="mt-6">
                        <button
                            ...
                            class="w-full font-bold px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600"
                        >
                            Send
                        </button>
                        <ToastContainer />
