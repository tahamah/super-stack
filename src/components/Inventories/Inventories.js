            ...
            <div className="grid mx-10 mt-10 gap-10  grid-cols-1 md:pt-28 md:grid-cols-2 max-w-7xl md:mx-auto">
                {data.map((p) => (
                    <div data-aos="fade-up" data-aos-duration="1000">
                        <div className="md:flex max-w-md mx-auto hover:bg-[#332467] duration-500  overflow-hidden rounded-lg shadow-lg  hover:text-gray-200 text-gray-700 transition ease-in-out delay-100 hover:drop-shadow-2xl hover:-translate-y-1   hover:scale-110  bg-gray-300">
