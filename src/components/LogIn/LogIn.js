            ...
            <div className="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800  lg:max-w-4xl">
                <div className="hidden bg-cover lg:block lg:w-1/2">
                    <img
                        ...
                        src="https://img.freepik.com/free-photo/online-delivery-shopping-food-order-concept-excited-amused-courier-red-uniform-bearde-del_1258-60861.jpg?w=1380"
                        alt=""
                    />
                </div>
                ...
                <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    <div className="flex cursor-pointer items-center justify-center mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg dark:border-gray-700   hover:bg-gray-50 ">
